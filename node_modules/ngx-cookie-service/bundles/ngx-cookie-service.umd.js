(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var CookieService = /** @class */ (function () {
         ...
         */
        CookieService.getCookieRegExp = function (name) {
            var escapedName = name.replace(/([\[\]\{\}\(\)\|\=\;\+\?\,\.\*\^\$])/gi, '\\$1');
            return new RegExp('(?:^' + escapedName + '|;\\s*' + escapedName + ')=(.*?)(?:;|$)', 'g');
        };
        CookieService.safeDecodeURIComponent = function (encodedURIComponent) {
            try {
    ...
    CookieService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function CookieService_Factory() { return new CookieService(i0__namespace.ɵɵinject(i1__namespace.DOCUMENT), i0__namespace.ɵɵinject(i0__namespace.PLATFORM_ID)); }, token: CookieService, providedIn: "root" });
